...
function setup() {
  ...
  button2.size(50,50);
  //1° Escribe el bloque de código correcto para agregar un botón que corte la cuerda.
...
function draw() 
{
  ...
  if(collide(fruit,bunny,80)==true)
  {
   ...
   bubble.visible = false;
    ...
    fruit = null;
   //2° Código para cambiar la animación del conejito cuando colisiona con la fruta y el conejito es detectado.  
